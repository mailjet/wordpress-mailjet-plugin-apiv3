    ...
    public static function getSettingsLeftMenu()
    {
        ...
        <ul>
            <li>
                ...
                <span><?php echo __('Connect your Mailjet account', 'wp-mailjet'); ?></span>
                </a>
                </div>
            </li>
            <li>
                ...
                <span><?php echo __('Sending settings', 'wp-mailjet'); ?></span>
                </a>
                </div>
            </li>
            <li>
                ...
                <span><?php echo __('Subscription options', 'wp-mailjet'); ?></span>
                </a>
                </div>
            </li>
            <li>
                <div class="settingsMenuLink settingsMenuLink4">
                    ...
                    <span><?php echo __('User access', 'wp-mailjet'); ?></span>
                    </a>
                </div>
            </li>
            <li>
                <div class="settingsMenuLink settingsMenuLink4">
                    ...
                    <span><?php echo __('Integrations', 'wp-mailjet'); ?></span>
                    </a>
                </div>
            </li>
        </ul>
