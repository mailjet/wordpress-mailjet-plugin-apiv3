    ...
    public static function getSettingsLeftMenu()
    {
        ...
        <ul>
            <li>
                ...
                <img width="16" id="settingsMenuLinkImg1" src=" <?php echo $defaultImg1; ?>" alt="<?php echo __('Connect your Mailjet account', 'mailjet'); ?>" />
            ...
            <li>
                ...
                <img width="16"  id="settingsMenuLinkImg2" src=" <?php echo $defaultImg2; ?>" alt="<?php echo __('Sending settings', 'mailjet'); ?>" />
            ...
            <li>
                ...
                <img width="16"  id="settingsMenuLinkImg3" src=" <?php echo $defaultImg3; ?>" alt="<?php echo __('Subscription options', 'mailjet'); ?>" />
            ...
            <li>
                ...
                <img width="16"  id="settingsMenuLinkImg4" src=" <?php echo $defaultImg4; ?>" alt="<?php echo __('User access', 'mailjet'); ?>" />
