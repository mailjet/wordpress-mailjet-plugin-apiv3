    ...
    public static function getSettingsLeftMenu()
    {
        ...
        <ul>
            <li>
                ...
                <span><?php echo __('Connect your Mailjet account', 'mailjet'); ?></span>
                </a>
                </div>
            </li>
            <li>
                ...
                <p><?php echo __('Sending settings', 'mailjet'); ?></p>
                </a>
                </div>
            </li>
            <li>
                ...
                <p><?php echo __('Subscription options', 'mailjet'); ?></p>
                </a>
                </div>
            </li>
            <li>
                ...
                <p><?php echo __('User access', 'mailjet'); ?></p>
                </a>
                </div>
            </li>
        </ul>
