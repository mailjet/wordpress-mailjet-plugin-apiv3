    ...
    public function mailjet_abandoned_cart_settings_page_html()
    {
                ...
                <div class="mj-popup">
                    <div class="mj-popup-header">
                        <h1>
                            ...
                            ?>
                        </h1><span> <a class="buttons-desktop-04-icon-01-def" id="mj-close" href="#" data-toggle="hide"
                                       onclick="togglePopup('mj-popup-confirm-ac')"><svg fill="currentColor"
                                                                                         preserveAspectRatio="xMidYMid meet"
                                                                                         height="16px" width="16px"
                                                                                         viewBox="0 0 16 16"
                                                                                         style="vertical-align: middle;"><g><path
                                                d="M14.4 0L8 6.4 1.601 0 0 1.6l6.4 6.399-6.4 6.4L1.601 16 8 9.6l6.4 6.4 1.6-1.601-6.4-6.4L16 1.6z"></path></g></svg></a></span>
                    </div>
                    <hr>
                    ...
                    <div class="mj-popup-footer mailjet_row">
                        <button class="mj-btn btnPrimary" data-toggle="hide"
                                onclick="togglePopup('mj-popup-confirm-ac')">
                            <?php
                    ...
                    <div class="mj-popup-header">
                        <h1>
                            ...
                            ?>
                                       ...
                                       onclick="togglePopup('mj-popup-stop-ac')"><svg fill="currentColor"
                                                                                      preserveAspectRatio="xMidYMid meet"
                                                                                      height="16px" width="16px"
                                                                                      viewBox="0 0 16 16"
                                                                                      style="vertical-align: middle;"><g><path
        ...
        <div class="mj-pluginPage">
            <div id="initialSettingsHead"><img
                        src="<?php echo plugin_dir_url(\dirname(__DIR__)) . '/admin/images/LogoMJ_White_RVB.svg'; ?>"
                ...
                <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post"
                    ...
                    <fieldset class="mj-form-content">
                        <div>
                            ...
                            <button type="button" id="mj-ac-tip-btn" class="mj-toggleTextBtn mj-toggleBtn"
                                    data-target="mj-ac-tip-text">
                                <?php
                        ...
                        <div class="mailjet_row">
                            <h2>
                                <?php
                                _e('Sending time', 'mailjet-for-wordpress');
                                ?>
                            </h2>
                            <div class="mj-time-setting">
                                <div id="sendingTimeInputs"
                                    ...
                                    ?>
                                >
                                    <input type="number" id="timeInput" name="abandonedCartSendingTime" value="<?php echo esc_attr($sendingTimeScaled); ?>"/>
                                    <select id="abandonedCartTimeScale" name="abandonedCartTimeScale">
                                        <option value="MINUTES" <?php echo esc_attr($sendingTimeScaleInMinutes) ? 'selected' : ''; ?>
                                        >
                                            <?php
                                            _e('minutes', 'mailjet-for-wordpress');
                                            ?>
                                        </option>
                                        <option value="HOURS"<?php echo esc_attr($sendingTimeScaleInMinutes) ? '' : 'selected';?> >
                                            <?php
                        ...
                        <div>
                            <h2>
                                <?php
                                _e('Template', 'mailjet-for-wordpress');
                                ?>
                            </h2>
                        </div>
                        <hr>
                    ...
                    <div class="mailjet_row mj-row-btn">
                        ...
                        if (!$isAbandonedCartActivated) {
                            ?>
                            <button id="mj-activate-ac-submit" class="mj-btn btnPrimary" type="submit"
                                    name="activate_ac" value="1">
                                <?php
                                _e('Activate sending', 'mailjet-for-wordpress');
                                ?>
                            </button>
                            <?php
                        } else {
            ...
            <script>
                ...
                function toggleTimeSettings(show) {
                    if (show) {
                        ...
                        timeField.value = <?php echo esc_attr($sendingTimeScaled); ?>;
                        timeScaleSelect.value = <?php echo esc_attr($sendingTimeScaleInMinutes) ? '"MINUTES"' : '"HOURS"';?>;
                    }
                }
                ...
                document.getElementById("mj-stop-ac-submit").onclick = () => {
                    displayPopup = true;
                };
                document.getElementById("mj-ac-edit-time").onclick = () => {
                    displayPopup = false;
                };
