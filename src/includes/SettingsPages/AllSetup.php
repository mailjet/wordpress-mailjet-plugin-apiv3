...
class AllSetup
{
    ...
    public function mailjet_allsetup_page_html()
    {
        ...
        //echo esc_html(get_admin_page_title());
                ...
                ?></h1>
                <p class="page_top_subtitle"><?php
                echo __('What would you like to do next?', 'mailjet-for-wordpress');
                ?></p>
                <div class="allsetup_blocks">
                    <div class="block_single">
                        <img src="<?php
                        echo plugin_dir_url(\dirname(\dirname(__FILE__))) . '/admin/images/all_setup_screen_signup_to_newsletter.png';
                        ?>" />
                        <div class="section_inner_title"><?php
                        ...
                        ?></p>
                        <div class="bottomBtn"><input name="nextBtnReverse" class="mj-btn btnPrimary" type="button" id="nextBtnReverse1" onclick="location.href = 'widgets.php'" value="<?php
                        _e('Manage my widgets', 'mailjet-for-wordpress');
                        ?>"></div>
                    </div>
                    <div class="block_single">
                        <img src="<?php
                        echo plugin_dir_url(\dirname(\dirname(__FILE__))) . '/admin/images/all_setup_screen_send_campaign.png';
                        ?>" />
                        <div class="section_inner_title"><?php
                        ...
                        ?></p>
                        <div class="bottomBtn"><input name="nextBtnReverse" class="mj-btn btnPrimary" type="button" id="nextBtnReverse2" onclick="location.href = 'admin.php?page=mailjet_settings_campaigns_menu'" value="<?php
                        _e('Create a campaign', 'mailjet-for-wordpress');
                        ?>"></div>
                    </div>
                    <div class="block_single">
                        <img src="<?php
                        echo plugin_dir_url(\dirname(\dirname(__FILE__))) . '/admin/images/all_setup_screen_configure.png';
                        ?>" />
                        <div class="section_inner_title"><?php
                        ...
                        ?></p>
                        <div class="bottomBtn"><input name="nextBtnReverse" class="mj-btn btnPrimary" type="button" id="nextBtnReverse3" onclick="location.href = 'admin.php?page=mailjet_sending_settings_page'" value="<?php
                ...
                <div class="allsetupGreenLinkDiv">
                    <?php
                    echo \sprintf(__('or <a class="greenLink" href="%s">Go to your Mailjet Plugin Homepage</a>', 'mailjet-for-wordpress'), "admin.php?page=mailjet_dashboard_page");
                    ?>
                </div>
