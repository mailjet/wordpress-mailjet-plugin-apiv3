...
class ConnectAccountSettings
{
    ...
    public function mailjet_connect_account_page_html()
    {
        ...
        add_settings_field(
                ...
                __('Mailjet API credentials', 'wp-mailjet'), array($this, 'mailjet_connect_account_cb'), 'mailjet_connect_account_page', 'mailjet_section_connect_account_settings', [
        ...
        ?>
                    ...
                    <div class="right">
                        <div class="centered">
                            ...
                            <h2 class="section_inner_title"><?php echo __('Connect your Mailjet account', 'wp-mailjet'); ?></h2>
