                    ...
                    <div class="col mj-grid">
                        <div class="block mj-box">
                            ...
                            <button name="nextBtnReverseDashboard" class="mj-btn btnPrimary"
                                    ...
                                    onclick="location.href = 'admin.php?page=mailjet_settings_campaigns_menu'"><?php
                        ...
                        <div class="block mj-box">
                            ...
                            <button name="nextBtnReverseDashboard" class="mj-btn btnPrimary"
                                    ...
                                    onclick="location.href = 'admin.php?page=mailjet_settings_contacts_menu'"><?php
                        ...
                        <div class="block mj-box">
                            ...
                            <button name="nextBtnReverseDashboard" class="mj-btn btnPrimary"
                                    ...
                                    onclick="location.href = 'admin.php?page=mailjet_order_notifications_page'"><?php
                    ...
                    <div class="col mj-grid">
                        <div class="block mj-box">
                            ...
                            <button name="nextBtnReverseDashboard" class="mj-btnSecondary" id="nextBtnReverseDashboard3"
                                    onclick="location.href = 'widgets.php'"><?php
                        ...
                        <div class="block mj-box">
                            ...
                            <button name="nextBtnReverseDashboard" class="mj-btn btnPrimary"
                                    id="nextBtnReverseDashboard4"
                                    onclick="location.href = 'admin.php?page=mailjet_settings_stats_menu'"><?php
                        ...
                        <div class="block mj-box">
                            ...
                            <button name="nextBtnReverseDashboard" class="mj-btn btnPrimary"
                                    ...
                                    onclick="location.href = 'admin.php?page=mailjet_abandoned_cart_page'"><?php
