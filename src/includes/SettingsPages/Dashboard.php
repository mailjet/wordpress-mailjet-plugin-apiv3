...
class Dashboard {
    ...
    public function mailjet_dashboard_page_html() {
        $iconDir                   = plugin_dir_url(dirname(__DIR__, 1)) . 'admin/images/woo.svg';
                ...
                <div class="initialSettingsMainCtn">
                    <div class="col mj-grid">
                        <div class="block mj-box">
                            ...
                            <?php
                            _e('My campaigns', 'mailjet-for-wordpress');
                            ?>
                            </h2>
                            <p>
                            <?php
                            echo __('Create and manage your newsletters. View your campaign statistics', 'mailjet-for-wordpress');
                            ?>
                            </p>
                            <button name="nextBtnReverseDashboard" class="mj-btn btnPrimary"
                                    id="nextBtnReverseDashboard1"
                                    onclick="location.href = 'admin.php?page=mailjet_settings_campaigns_menu'">
                                    <?php
                                    echo __('Manage campaigns', 'mailjet-for-wordpress');
                                    ?>
                                    </button>
                        </div>
                        <div class="block mj-box">
                            ...
                            <?php
                            _e('My contact lists', 'mailjet-for-wordpress');
                            ?>
                            </h3>
                            <p class="blockText">
                            <?php
                            _e('View and manage your contact lists', 'mailjet-for-wordpress');
                            ?>
                            </p>
                            <button name="nextBtnReverseDashboard" class="mj-btn btnPrimary"
                                    id="nextBtnReverseDashboard2"
                                    onclick="location.href = 'admin.php?page=mailjet_settings_contacts_menu'">
                                    <?php
                                    _e('Manage contacts', 'mailjet-for-wordpress');
                                    ?>
                                    </button>
                        </div>
                        <?php
                        if ($wooCommerceIntegActivated) {
                            ?>
                        <div class="block mj-box">
                            <div>
                                <h3 class="section-header">
                            ...
                            <p class="blockText">
                            <?php
                            _e('Activate order notification emails to inform customers of any new purchase, shipping or refund.', 'mailjet-for-wordpress');
                            ?>
                            </p>
                            <button name="nextBtnReverseDashboard" class="mj-btn btnPrimary"
                                    id="nextBtnReverseDashboard4"
                                    onclick="location.href = 'admin.php?page=mailjet_order_notifications_page'">
                                    <?php
                                    _e('Manage transactional emails', 'mailjet-for-wordpress');
                                    ?>
                                    </button>
                        </div>
                            <?php
                    ...
                    <div class="col mj-grid">
                        <div class="block mj-box">
                            <h3 class="section-header">
                            <?php
                            _e('Subscription form', 'mailjet-for-wordpress');
                            ?>
                            </h3>
                            <p class="blockText">
                            <?php
                            _e('Customize a subscription form and add it to your WordPress website', 'mailjet-for-wordpress');
                            ?>
                            </p>
                            <button name="nextBtnReverseDashboard" class="mj-btnSecondary" id="nextBtnReverseDashboard3"
                                    onclick="location.href = 'widgets.php'">
                                    <?php
                                    echo __('Add widget', 'mailjet-for-wordpress');
                                    ?>
                                    </button>
                        </div>
                        <div class="block mj-box">
                            <h3 class="section-header">
                            <?php
                            _e('Statistics', 'mailjet-for-wordpress');
                            ?>
                            </h3>
                            <p class="blockText">
                            <?php
                            _e('View your sending statistics over a period of time', 'mailjet-for-wordpress');
                            ?>
                            </p>
                            <button name="nextBtnReverseDashboard" class="mj-btn btnPrimary"
                                    id="nextBtnReverseDashboard4"
                                    onclick="location.href = 'admin.php?page=mailjet_settings_stats_menu'">
                                    <?php
                                    _e('View statistics', 'mailjet-for-wordpress');
                                    ?>
                                    </button>
                        </div>
                        <?php
                        ...
                        <div class="block mj-box">
                            ...
                            <p class="blockText">
                            <?php
                            _e('Recover visitors and turn them into customers but reminding them what they left in their cart.', 'mailjet-for-wordpress');
                            ?>
                            </p>
                            <button name="nextBtnReverseDashboard" class="mj-btn btnPrimary"
                                    id="nextBtnReverseDashboard3"
                                    onclick="location.href = 'admin.php?page=mailjet_abandoned_cart_page'">
                                    <?php
                                    echo __('Manage abandoned cart', 'mailjet-for-wordpress');
                                    ?>
                                    </button>
                        </div>
                            <?php
