            ...
            <div id="initialContactListsForm">
                ...
                <form action="options.php" method="post">
                    ...
                    if (MailjetApi::isValidAPICredentials()) {
                        submit_button('Apply and continue', 'mj-btn btnPrimary MailjetSubmit', 'submit', false, array('id' => 'initialContactListsSubmit'));
                    } else {
                    ...
                    <input name="nextBtn" class="mj-btn btnSecondary nextBtn" type="button" id="nextBtn" onclick="location.href = 'admin.php?page=mailjet_allsetup_page'" value="<?=(true !== $applyAndContinueBtnClicked) ? __('Skip this step', 'mailjet') : __('Next', 'mailjet')?>">
