...
class InitialContactListsSettings
{
    ...
    public function mailjet_initial_contact_lists_cb($args)
    {
        ...
        <fieldset class="initialContactListsFieldset">
            ...
            <p><?php echo __("Please select a Mailjet contact list below to automatically add all future Wordpress users. Each new user's email address and role (subscriber, administrator, author, …) will be synchronized to the list and available for use inside Mailjet.", 'wp-mailjet'); ?></p>
            ...
            <div class="activate_mailjet_sync_field">
                ...
                <div id="activate_mailjet_sync_form" class="<?= ($mailjetSyncActivated == 1 ? ' mj-show' : 'mj-hide') ?>">
                    <div class="mailjet_sync_options_div">
                        <h4><?php _e('Your Mailjet contact lists', 'wp-mailjet'); ?></h4>
