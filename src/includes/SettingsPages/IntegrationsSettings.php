        ...
        <fieldset class="settingsSubscrFldset">
            ...
            <div id="activate_mailjet_woo_form"
                ...
                <label class="checkboxLabel">
                    <input name="activate_mailjet_woo_sync" type="checkbox" id="activate_mailjet_woo_sync"
                ...
                <div id="woo_contact_list"
                     class="<?php echo( $mailjetWooSyncActivated == 1 ? ' mj-show' : 'mj-hide' ) ?> mailjet_sync_woo_div">
                    <select class="mj-select" name="mailjet_woo_list" id="mailjet_woo_list"
                            type="select" <?php echo( $wooCommerceNotInstalled == true ? ' disabled="disabled"' : '' ) ?>>
                        <?php
                        foreach ( $mailjetContactLists as $mailjetContactList ) {
                            ...
                            ?>
                            <option value="<?= $mailjetContactList['ID'] ?>" <?= ( $mailjetWooList == $mailjetContactList['ID'] ? 'selected="selected"' : '' ) ?> > <?= $mailjetContactList['Name'] ?>
        ...
        <fieldset class="settingsSubscrFldset">
            ...
            <label class="checkboxLabel">
                <input name="activate_mailjet_cf7_integration" type="checkbox" id="activate_mailjet_cf7_integration"
                       value="1" <?php echo( $mailjetCF7IntegrationActivated == 1 ? ' checked="checked"' : '' ) ?>  <?php echo( $isCF7Installed === false ? ' disabled="disabled"' : '' ) ?>
                       autocomplete="off">
                <span><?php _e( 'Enable Contact Form 7 integration', 'mailjet-for-wordpress' ); ?></span>
            </label>

            <div id="activate_mailjet_cf7_form"
                 class="<?= ( $mailjetCF7IntegrationActivated == 1 ? ' mj-show' : 'mj-hide' ) ?> ">
                <!--<div id="activate_mailjet_cf7_form" >-->
                <!--                <label class="checkboxLabel">
