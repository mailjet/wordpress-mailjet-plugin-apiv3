            ...
            <div class="mainContainer dashboard">
                ...
                <form action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" method="post" id="order-notification-form">
                    <fieldset class="mj-form-content">
                        ...
                        set_query_var('templateFrom', sprintf('%s &lt%s&gt', (isset($orderConfTemplate['Headers']['SenderName']) ?: ''), $orderConfTemplate['Headers']['SenderEmail']));
                        ...
                        set_query_var('templateFrom', sprintf('%s &lt%s&gt', (isset($shippingTemplate['Headers']['SenderName']) ?: ''), $shippingTemplate['Headers']['SenderEmail']));
                        ...
                        set_query_var('templateFrom', sprintf('%s &lt%s&gt', (isset($refundTemplate['Headers']['SenderName']) ?: ''), $refundTemplate['Headers']['SenderEmail']));
