...
class UserAccessSettings
{
    ...
    public function mailjet_user_access_cb($args)
    {
        ...
        <fieldset class="settingsAccessFldset">
            <legend class="screen-reader-text"><span><?php  _e('User Access', 'wp-mailjet'); ?></span></legend>
            <label class="checkboxLabel" for="mailjet_access_administrator">
                ...
                <span><?php _e('Administrator', 'wp-mailjet'); ?></span>
            </label>
            <label class="checkboxLabel" class="mj-label" for="mailjet_access_editor">
                ...
                <span><?php _e('Editor', 'wp-mailjet'); ?></span>
            </label>
            <label class="checkboxLabel" class="mj-label" for="mailjet_access_author">
                ...
                <span><?php _e('Author', 'wp-mailjet'); ?></span>
            </label>
            <label class="checkboxLabel" class="mj-label" for="mailjet_access_contributor">
                ...
                <span><?php _e('Contributor', 'wp-mailjet'); ?></label>
            <label class="checkboxLabel" class="mj-label" for="mailjet_access_subscriber">
                ...
                <?php _e('Subscriber', 'wp-mailjet'); ?></span>
            </label>
        </fieldset>
    ...
    public function mailjet_user_access_page_html()
    {
        ...
        if (isset($_GET['settings-updated'])) {
            ...
            add_settings_error('mailjet_messages', 'mailjet_message', __('User Access Settings Saved', 'wp-mailjet'), 'updated');
        }
        ...
        <!--                    <h1>--><?php //echo esc_html(get_admin_page_title()); ?><!--</h1>-->
                            <h2 class="section_inner_title"><?php _e('User access', 'wp-mailjet'); ?></h2>
            ...
            <div class="bottom_links">
                <div class="needHelpDiv">
                    <img src=" <?php echo plugin_dir_url(dirname(dirname(__FILE__))) . '/admin/images/need_help.png'; ?>" alt="<?php _e('Need help?', 'wp-mailjet'); ?>" />
                    <?php _e('Need help?', 'wp-mailjet' ); ?>
                </div>
