...
echo plugin_dir_url(\dirname(\dirname(__FILE__))) . '/admin/images/need_help.png';
?>" alt="<?php 
echo __('Need help?', 'mailjet-for-wordpress');
?>" />
		<?php 
echo __('Need help?', 'mailjet-for-wordpress');
?>
...
?> <img class="heart-icon" src="https://www.mailjet.com//wp-content/uploads/mailjet-coeur.png" alt="">
</div><?php 
