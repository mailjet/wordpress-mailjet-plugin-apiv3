...
<fieldset class="settingsSubscrFldset">
    <label class="mailjet-label" for="activate_mailjet_sync"><?php 
...
?>
                    ...
                    <label id="checkbox-add-users" class="checkboxLabel">
                        ...
                        <span><?php 
echo \sprintf(__('Also, add existing %s WordPress users (initial synchronization)', 'mailjet-for-wordpress'), $wpUsersCount);
?></span>
                    </label>
                </div>
			</div>
	...
	<label class="mailjet-label" for="activate_mailjet_comment_authors_sync"><?php 
