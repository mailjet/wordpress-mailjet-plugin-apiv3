                                                    ...
                                                    <table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                                        <tbody>
                                                            <tr>
                                                                <td style="word-wrap:break-word;font-size:0px;padding:10px 25px;padding-top:0px;padding-bottom:20px;" align="left">
                                                                    <div style="cursor:auto;color:#5e6977;font-family:Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;">
                                                                        <h1 style="font-family: 'Trebuchet MS', Helvetica, Arial, sans-serif; font-size: 28px; font-weight: normal; line-height: 32px;"><b><span style="font-family:Arial,sans-serif">__EMAIL_TITLE__</span></b></h1>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                    ...
                                                                    <div style="cursor:auto;color:#5e6977;font-family:Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;">
                                                                        <p style="font-size: 15px; margin: 10px 0;">
                                                                            ...
                                                                            <!--                                                        To receive newsletters from: 
                                                                                                                                    <a target="_blank" href="__WP_URL__" style="color: #00a6f9; text-decoration: underline; text-decoration: none;">
                                                                                                                                        <span style="color:#00a6f9">__WP_URL__</span>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="border:none;border-radius:3px;color:#ffffff;cursor:auto;padding:10px 25px;" align="center" valign="middle" bgcolor="#00a6f9">
                                                                                    <a href="__CONFIRM_URL__" style="text-decoration:none;background:#00a6f9;color:#ffffff;font-family:Arial, sans-serif;font-size:16px;font-weight:normal;line-height:120%;text-transform:none;margin:0px;"><b>__CLICK_HERE__</b></a>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                            ...
                                                            <tr>
                                                                <td style="word-wrap:break-word;font-size:0px;padding:10px 25px;padding-top:0px;padding-bottom:0px;" align="left">
                                                                    <div style="cursor:auto;color:#5e6977;font-family:Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;">
                                                                        <p style="font-size: 15px; margin: 10px 0;">__IGNORE__</p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
