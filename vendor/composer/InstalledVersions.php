 ...
 */
namespace MailjetWp\Composer;

use MailjetWp\Composer\Autoload\ClassLoader;
use MailjetWp\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('MailjetWp\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
