...
use MailjetWp\Composer\Installer\BinaryInstaller;
use MailjetWp\Composer\Installer\LibraryInstaller;
use MailjetWp\Composer\IO\IOInterface;
use MailjetWp\Composer\Package\Package;
use MailjetWp\Composer\Package\PackageInterface;
use MailjetWp\Composer\Repository\InstalledRepositoryInterface;
use MailjetWp\Composer\Util\Filesystem;
use MailjetWp\React\Promise\PromiseInterface;
