...
final class MailjetApiv3Test extends TestCase
{
    ...
    {
        $client = new Client($this->publicKey, $this->secretKey, \true);
        $this->assertUrl('/REST/contact', $client->get(Resources::$Contact));
        $this->assertFilters(['id' => 2], $client->get(Resources::$Contact, ['filters' => ['id' => 2]], ['version' => 'v3.1']));
        ...
        $this->assertUrl('/REST/contact/test@mailjet.com', $client->get(Resources::$Contact, ['id' => 'test@mailjet.com']));
    ...
    public function testPostV31()
    {
        ...
        $email = ['Messages' => [['From' => ['Email' => 'test@mailjet.com', 'Name' => 'Mailjet PHP test'], 'TextPart' => 'Simple Email test', 'To' => [['Email' => 'test@mailjet.com', 'Name' => 'Test']]]]];
    ...
    {
        static::assertTrue($client->setSecureProtocol(\true));
