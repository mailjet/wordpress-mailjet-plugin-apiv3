...
namespace MailjetWp\Psr\Log\Test;

use MailjetWp\Psr\Log\LoggerInterface;
use MailjetWp\Psr\Log\LogLevel;
/**
 ...
 */
abstract class LoggerInterfaceTest extends \MailjetWp\PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->assertInstanceOf('MailjetWp\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('MailjetWp\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('MailjetWp\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
